        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarrierName = table.Column<string>(type: "NVARCHAR(100)", nullable: false),
                    ShippingStatus = table.Column<byte>(type: "TINYINT", nullable: false),
                    TrackingNumber = table.Column<string>(type: "NVARCHAR(100)", nullable: false),
                    EstimatedDeliveryDate = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    ActualDeliveryDate = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    OrderID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
